    ...
    def RefreshDrumMode(self, clearFirst = False):
        ...
        if clearFirst:
            for pad in range(0, 64):
                nfx_Helpers.SetPadColor(pad, 0,0) 
        ...
        if (self.CurrentDrumMode == DrumModeFPC) | (self.CurrentDrumMode == DrumModeFPCCenter):
            ...
            drumPads = nfx_Helpers.getFPCPads(self.CurrentDrumMode == DrumModeFPC)
            ...
            for idx, pad in enumerate(drumPads):
                ...
                if(nfx_Helpers.isFPCChannel(chanIdx)):
                    dim = 1 
                    color = plugins.getPadInfo(chanIdx, -1, nfx_Helpers.PAD_Color, idx)
                    semitone = plugins.getPadInfo(chanIdx, -1, nfx_Helpers.PAD_Semitone, idx)
                ...
                nfx_Helpers.SetPadColor(pad, color, dim)
